...
kangaroo.positionX = camera.positionX;
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    if(keyDown("space")&& kangaroo.y>40) {
      
      jumpSound.play();
      kangaroo.velocityY = -19;
    }
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
shrub = createSprite(450,380,30,30);
//Set the x-position of the shrub according to the game camera.
shrub.positionX = camera.positionX;
